...
export default function EventModal({ event, onClose }) {
  ...
  // For classes, use startTime and endTime; for events, use start and end
  const startDate = event.startTime || event.start || new Date(event.startTime || event.start);
  const endDate = event.endTime || event.end || new Date(event.endTime || event.end);
    ...
    <div className="modal-overlay">
      <div className="modal-container">
        <div
          ...
          style={event.color ? { borderTop: `4px solid ${event.color}` } : {}}
        >
            ...
            {(event.location ||
              ...
              <div className="password-form-group">
                ...
                <div className="password-input">
                  {event.location ||
                    (courseInfo && courseInfo.schedule && courseInfo.schedule.length > 0
                      ? courseInfo.schedule.find((s) => s.classType === event.classType)
